...
def train():
    ...
    print('Complete')
    #Save model params
    torch.save(policy_net.state_dict(), 'models/pytorch-eg-cartpole-policy.pt')
    torch.save(target_net.state_dict(), 'models/pytorch-eg-cartpole-target.pt')
